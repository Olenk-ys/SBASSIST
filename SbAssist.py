...
XeberlhynBoss = LINE("TOKEN SB ATAU INDUK",appName="IOS\t10.1.1\tiOS\t13.3.1")
Xeberlhyn1 = LINE("TOKEN ASSIST",appName="IOS\t10.1.1\tiOS\t13.3.1")
XeberlhynAJS = LINE("TOKEN ANTIJS",appName="IOS\t10.1.1\tiOS\t13.3.1")
#XeberlhynBoss = LINE("EMAIL SB","PAWORD EMAIL SB DISINI")
#Xeverlhyn1 = LINE("EMAIL ASIST","PAWORD EMAIL ASIST DISINI")
...
People1 = Xeberlhyn1.getProfile().mid
Berlin = XeberlhynAJS.getProfile().mid
Pasukan =[People,People1,Berlin]
ABC = [XeberlhynBoss,Xeberlhyn1]
Creators = ["TAROK MIDMU DISINI"]
President = "TAROK MIDMU DISINI"
JandaBahenol = []
Bangsat = {
    "Daftarhitam": {},
    "link": {},
        ...
        if TeamPeopleBoTS.type == 13:
                        ...
                        if BangsatTerhormat.invitee is not None:
                            ...
                            for MakhlukJahanam in FuckyouMan:
                                if MakhlukJahanam in TeamPeopleBoTS.param3:
                                    random.choice(ABC).cancelGroupInvitation(TeamPeopleBoTS.param1, [MakhlukJahanam])
                                    random.choice(ABC).TendanganMautiniBOSS(TeamPeopleBoTS.param1, [MakhlukJahanam])
                            random.choice(ABC).TendanganMautiniBOSS(TeamPeopleBoTS.param1, [TeamPeopleBoTS.param2])
                    except:
                        pass
            if TeamPeopleBoTS.param3 in Bangsat["Daftarhitam"]:
                if TeamPeopleBoTS.param2 not in Creators and TeamPeopleBoTS.param2 not in Pasukan and TeamPeopleBoTS.param2 not in Bangsat["Algojo"]:
                    ...
                    try:
                        random.choice(ABC).cancelGroupInvitation(TeamPeopleBoTS.param1, [TeamPeopleBoTS.param3])
                        random.choice(ABC).TendanganMautiniBOSS(TeamPeopleBoTS.param1, [TeamPeopleBoTS.param2])
                    except:
                        pass                    
        if TeamPeopleBoTS.type == 13:
                        ...
                        if BrutalKelasDewa.invitee is not None:
                           ...
                           for MakhlukBiadap in FuckyouMan:
                               if MakhlukBiadap in TeamPeopleBoTS.param3:
                                  ...
                                  random.choice(ABC).cancelGroupInvitation(TeamPeopleBoTS.param1,[MakhlukBiadap])
                                  random.choice(ABC).TendanganMautiniBOSS(TeamPeopleBoTS.param1, [MakhlukBiadap])
                           random.choice(ABC).TendanganMautiniBOSS(TeamPeopleBoTS.param1,[TeamPeopleBoTS.param2])
                    except:pass
        ...
        if TeamPeopleBoTS.type == 11:
            if TeamPeopleBoTS.param2 in Bangsat["Daftarhitam"]:
                try:
                    ...
                    try:
                        if Xeberlhyn1.getGroup(TeamPeopleBoTS.param1).preventedJoinByTicket == False:
                            if TeamPeopleBoTS.param2 not in Creators and TeamPeopleBoTS.param2 not in Pasukan and TeamPeopleBoTS.param2 not in Bangsat["Algojo"]:
                                Xeberlhyn1.reissueGroupTicket(TeamPeopleBoTS.param1)
                                X = Xeberlhyn1.getGroup(TeamPeopleBoTS.param1)
                                X.preventedJoinByTicket = True
                                Xeberlhyn1.updateGroup(X)
                                Xeberlhyn1.TendanganMautiniBOSS(TeamPeopleBoTS.param1,[TeamPeopleBoTS.param2])
                    except:
                        pass
                ...
                if TeamPeopleBoTS.param1 in JandaBahenol:
                    if TeamPeopleBoTS.param3 in People:
                        if TeamPeopleBoTS.param2 not in Creators and TeamPeopleBoTS.param2 not in Pasukan and TeamPeopleBoTS.param2 not in Bangsat["Algojo"]:
                            ...
                            Xeberlhyn1.acceptGroupInvitationByTicket(TeamPeopleBoTS.param1,SuratPanggilan)
                ...
                if TeamPeopleBoTS.param2 not in Creators and TeamPeopleBoTS.param2 not in Pasukan and TeamPeopleBoTS.param2 not in Bangsat["Algojo"]:
                    if TeamPeopleBoTS.param3 in Creators:
                        if TeamPeopleBoTS.param1 in JandaBahenol:
                            ...
                            XeberlhynBoss.BecauseMyTeAmPEOPLEBOT(TeamPeopleBoTS.param1,"⌬ Pengurus Bot Diinvitr")
                else:
                    pass
            except:
                pass
                        ...
                        if text is None:
                            ...
                            if ThePeopleTeamBOTS == "status":
                                if AreyouReady in Creators:
                                    ...
                                    AnakPerawanBisaDesah += "╰────「 Team People Bot 」"
                            ...
                            if ThePeopleTeamBOTS == "rechat":
                                if AreyouReady in Creators:
                                    ...
                                    Xeberlhyn1.removeAllMessages(TeamPeopleBoTS.param2)
                                    XeberlhynBoss.BecauseMyTeAmPEOPLEBOT(ByCreatorsBerlHyn, "「Succes menghapus semua pesan」")
                                    Xeberlhyn1.BecauseMyTeAmPEOPLEBOT(ByCreatorsBerlHyn, "「Succes menghapus semua pesan」")
                            if ThePeopleTeamBOTS == "respon":
                                if AreyouReady in Creators:
                                    XeberlhynBoss.BecauseMyTeAmPEOPLEBOT(ByCreatorsBerlHyn, "「Hadir Boss ku」")
                                    Xeberlhyn1.BecauseMyTeAmPEOPLEBOT(ByCreatorsBerlHyn, "「Hadir Boss ku」")
                            if ThePeopleTeamBOTS == "speed":
                                if AreyouReady in Creators:
                                    ...
                                    Xeberlhyn1.BecauseMyTeAmPEOPLEBOT(ByCreatorsBerlHyn, "{}".format(str(Keputusan)))
                            if ThePeopleTeamBOTS == "byeall":
                                if AreyouReady in Creators:
                                    if ShirashiBOTSPeoplE.toType == 2:
                                        try:
                                            Xeberlhyn1.leaveGroup(ByCreatorsBerlHyn)
                                        except:pass
                            ...
                            if ThePeopleTeamBOTS == "joinall":
                                if AreyouReady in Creators:
                                    ...
                                    Xeberlhyn1.acceptGroupInvitationByTicket(ByCreatorsBerlHyn,SuratUndangan)
                                    Xeberlhyn1.BecauseMyTeAmPEOPLEBOT(ByCreatorsBerlHyn,"「Assist berhasil masuk kedalam group」")
                                    G = XeberlhynBoss.getGroup(ByCreatorsBerlHyn)
                                    G.preventedJoinByTicket = True
                                    XeberlhynBoss.updateGroup(G)
                            if ThePeopleTeamBOTS == "ghost in":
                                if AreyouReady in Creators:
                                    G = XeberlhynBoss.getGroup(ByCreatorsBerlHyn)
                                    ginfo = XeberlhynBoss.getGroup(ByCreatorsBerlHyn)
                                    G.preventedJoinByTicket = False
                                    ...
                                    XeberlhynAJS.BecauseMyTeAmPEOPLEBOT(ByCreatorsBerlHyn,"「Ghost berhasil masuk kedalam group」")
                                    G = XeberlhynBoss.getGroup(ByCreatorsBerlHyn)
                                    G.preventedJoinByTicket = True
                                    XeberlhynBoss.updateGroup(G)
                            if ThePeopleTeamBOTS == "ghost bye":
                                if AreyouReady in Creators:
                                    if ShirashiBOTSPeoplE.toType == 2:
                                        try:
                                            XeberlhynAJS.leaveGroup(ByCreatorsBerlHyn)
                                        except:pass
                            if ThePeopleTeamBOTS == "antijs stay":
                                if AreyouReady in Creators:
                                    Xeberlhyn1.inviteIntoGroup(ByCreatorsBerlHyn, [Berlin])
                                    XeberlhynBoss.BecauseMyTeAmPEOPLEBOT(ByCreatorsBerlHyn,"「Antijs telah stay dipendingan grup」")
                            if ThePeopleTeamBOTS == "cek status":
                                if AreyouReady in Creators:
                                    ...
                                    if LonteArab == "OK":Terhormat = "~ Ready"
                                    else:Terhormat = "~ Limit"
                                    XeberlhynBoss.BecauseMyTeAmPEOPLEBOT(ByCreatorsBerlHyn, Terhormat)
                                    try:Xeberlhyn1.inviteIntoGroup(ByCreatorsBerlHyn, [People1]);LonteArab = "OK"
                                    except:LonteArab = "NOT"
                                    if LonteArab == "OK":Terhormat = "~ Ready"
                                    else:Terhormat = "~ Limit"
                                    Xeberlhyn1.BecauseMyTeAmPEOPLEBOT(ByCreatorsBerlHyn, Terhormat)
                            ...
                            if ThePeopleTeamBOTS.startswith("asadd: "):
                                if AreyouReady in Creators:
                                   PersetanBuatHatters = eval(ShirashiBOTSPeoplE.contentMetadata["MENTION"])
                                   PersetanBuatHatters["MENTIONEES"][0]["M"]
                                   MakhlukBiadaps = []
                                   ...
                                   for MakhlukBiadap in MakhlukBiadaps:
                                      try:
                                          Xeberlhyn1.findAndAddContactsByMid(MakhlukBiadap)
                                          Xeberlhyn1.BecauseMyTeAmPEOPLEBOT(ByCreatorsBerlHyn," "+str(Xeberlhyn1.getContact(MakhlukBiadap).displayName)+"~ Telah ditambahkan menjadi teman")
                                      except:Xeberlhyn1.BecauseMyTeAmPEOPLEBOT(ByCreatorsBerlHyn," Gua limit add asyu ")
                            ...
                            if ThePeopleTeamBOTS.startswith("sbkick: "):
                                if AreyouReady in Creators:
                                   ...
                                   for MakhlukBiadap in MakhlukBiadaps:
                                      ...
                                      except:XeberlhynBoss.BecauseMyTeAmPEOPLEBOT(ByCreatorsBerlHyn," Gua limit kick sue ")
                            if ThePeopleTeamBOTS.startswith("askick: "):
                                if AreyouReady in Creators:
                                   PersetanBuatHatters = eval(ShirashiBOTSPeoplE.contentMetadata["MENTION"])
                                   PersetanBuatHatters["MENTIONEES"][0]["M"]
                                   MakhlukBiadaps = []
                                   ...
                                   for MakhlukBiadap in MakhlukBiadaps:
                                      try:
                                          Bangsat["Daftarhitam"][MakhlukBiadap] = True
                                          Xeberlhyn1.TendanganMautiniBOSS(ByCreatorsBerlHyn, [MakhlukBiadap])
                                          Xeberlhyn1.BecauseMyTeAmPEOPLEBOT(ByCreatorsBerlHyn," "+str(Xeberlhyn1.getContact(MakhlukBiadap).displayName)+"~ Telah dikeluarkan dari room")
                                      except:Xeberlhyn1.BecauseMyTeAmPEOPLEBOT(ByCreatorsBerlHyn," Gua limit kick sue ")
                            if ThePeopleTeamBOTS.startswith("addbots: "):
                                if AreyouReady in Creators:
                                   ...
                                   for MakhlukBiadap in MakhlukBiadaps:
                                      ...
                                      except:XeberlhynBoss.BecauseMyTeAmPEOPLEBOT(ByCreatorsBerlHyn," Telah terdaftar didalam daftar bot")
                            if ThePeopleTeamBOTS.startswith("dellbots: "):
                                if AreyouReady in Creators:
                                   ...
                                   for MakhlukBiadap in MakhlukBiadaps:
                                      ...
                                      except:XeberlhynBoss.BecauseMyTeAmPEOPLEBOT(ByCreatorsBerlHyn," Belum terdaftar didalam daftar bot")
                            ...
                            if ThePeopleTeamBOTS.startswith("asgantinama:"):
                                if AreyouReady in Creators:
                                    AyamJumbo = text.split(":")
                                    PapanNama = text.replace(AyamJumbo[0] + ":","")
                                    MariaOzawa = Xeberlhyn1.getProfile()
                                    MariaOzawa.displayName = str(PapanNama)
                                    Xeberlhyn1.updateProfile(MariaOzawa)
                                    Xeberlhyn1.BecauseMyTeAmPEOPLEBOT(ByCreatorsBerlHyn, "Selfbots sukses mengganti nama menjadi:\n{}".format(PapanNama))
                            ...
                            if ThePeopleTeamBOTS == "protectinvite on":
                                if AreyouReady in Creators:
                            ...
                            if ThePeopleTeamBOTS == "protectinvite off":
                                if AreyouReady in Creators:
                ...
                if ShirashiBOTSPeoplE.contentType == 1:
                    if AreyouReady in Creators:
                        if Bangsat["SelfiPakeHandiCam"] == True:
                            ...
                            AwasAdaDudaJanda = Xeberlhyn1.downloadObjectMsg(ShirashiBOTSPeoplE.id)
                            ...
                            Xeberlhyn1.updateProfilePicture(AwasAdaDudaJanda)
                            ...
                            Xeberlhyn1.BecauseMyTeAmPEOPLEBOT(ByCreatorsBerlHyn, "「Sukses mengganti Foto profile」")
        ...
        if TeamPeopleBoTS.type == 19: 
            if People in TeamPeopleBoTS.param3:
                if TeamPeopleBoTS.param2 not in Creators and TeamPeopleBoTS.param2 not in Pasukan and TeamPeopleBoTS.param2 not in Bangsat["Algojo"]:
                    ...
                    try:                                            
                        Xeberlhyn1.TendanganMautiniBOSS(TeamPeopleBoTS.param1,[TeamPeopleBoTS.param2])
                        Xeberlhyn1.inviteIntoGroup(TeamPeopleBoTS.param1,[TeamPeopleBoTS.param3])
                        XeberlhynBoss.acceptGroupInvitation(TeamPeopleBoTS.param1)
                    except:
                        try:
                            XeberlhynAJS.acceptGroupInvitation(TeamPeopleBoTS.param1)
                ...
                return
            if People1 in TeamPeopleBoTS.param3:
                if TeamPeopleBoTS.param2 not in Creators and TeamPeopleBoTS.param2 not in Pasukan and TeamPeopleBoTS.param2 not in Bangsat["Algojo"]:
                    Bangsat["Daftarhitam"][TeamPeopleBoTS.param2] = True
                    try:                                            
                        XeberlhynBoss.TendanganMautiniBOSS(TeamPeopleBoTS.param1,[TeamPeopleBoTS.param2])
                        XeberlhynBoss.inviteIntoGroup(TeamPeopleBoTS.param1,[TeamPeopleBoTS.param3])
                        Xeberlhyn1.acceptGroupInvitation(TeamPeopleBoTS.param1)
                    except:
                        try:
                            XeberlhynAJS.acceptGroupInvitation(TeamPeopleBoTS.param1)
                            G = XeberlhynAJS.getGroup(TeamPeopleBoTS.param1)
            ...
            if Berlin in TeamPeopleBoTS.param3:
                if TeamPeopleBoTS.param2 not in Creators and TeamPeopleBoTS.param2 not in Pasukan and TeamPeopleBoTS.param2 not in Bangsat["Algojo"]:
                    Bangsat["Daftarhitam"][TeamPeopleBoTS.param2] = True
                    try:
                        G = Xeberlhyn1.getGroup(TeamPeopleBoTS.param1)
                        G.preventedJoinByTicket = False
                        Xeberlhyn1.updateGroup(G)
                        invsend = 0
                        SuratPanggilan = Xeberlhyn1.reissueGroupTicket(TeamPeopleBoTS.param1)
